...
#BBR
wget –no-check-certificate raw.githubusercontent.com/jzyt2022/v2/main/install_bbr.sh 
chmod +x install_bbr.sh 
./install_bbr.sh

#v2fly
wget raw.githubusercontent.com/jzyt2022/v2/main/v2fly_install.sh
chmod -R 777 v2fly_install.sh
./v2fly_install.sh

#wget -cO /usr/local/etc/v2ray/config.json raw.githubusercontent.com/jzyt2022/v2/main/v2fly_config.json
